...
object FutureDemo extends App {
  ...
  // первая фьюча формирует и возвращает строку
  def getFuture1 = Future {
    "1337"
  }

  // вторая фьюча из строки делает число
  def getFuture2(string: String) = Future {
    string.toInt
  }

  // комбинированная фьюча, созданная с использованием for-включения
  ...
  // комбинированная фьюча, созданная с использованием flatMap и map
